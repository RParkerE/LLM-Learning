...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        mask_bool = self.mask.to(device).bool()[:num_tokens, :num_tokens]
...
GPT_CONFIG_124M = {
    "vocab_size": 50257,    #tiktoken - gpt2 token size
    "context_length": 256,
    "emb_dim": 768,
    "n_heads": 12,
    "n_layers": 12,
...
token_ids = generate(
    model=gpt,
    idx=text_to_token_ids("Temptations come in the form", tokenizer).to(device),
    max_new_tokens=25,
